# Lance le script avec les privilèges administrateur
##################################################
...
# Installer quelques programmes utiles
...
# Désinstaller quelques programmes inutiles
...
# Réinitialiser la politique d’éxecution
